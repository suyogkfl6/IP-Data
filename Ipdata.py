...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        Coded By Suyog Kafle         |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|  www.facebook.com/suyogkpl          |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " Suyog Kafle")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 23/7/2021")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " Suyogkfl6")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "          [+] www.fb.com/suyogkfl [+]          ")
       slowprint ("\033[1;91m -----------------------------------------------")
...
def ext():
      ...
      def exitt():
      	   slowprint ("\033[1;36m ==============================================")
      slowprint ("\033[1;33m|      Suyog The programmer                    |")
      slowprint ("\033[1;36m ==============================================")
...
def main():
      ...
      print("     ")
      option = input("\033[1;36m [+] Choose Number >> \033[1;32m")
      if option == "1":
          os.system("clear")
          ipinfo()
          exit()
